                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            <li><a href="kaprodi_dash.html"><i class="fa fa-home"></i> Dashboard</a></li>
                            <li><a><i class="fa fa-check"></i> Persetujuan <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="kaprodi_terimaproposal.html">Proposal</a></li>
                                    <li><a href="kaprodi_terimasidang.html">Sidang</a></li>
                                    <li><a href="kaprodi_terimayudisium.html">Yudisium</a></li>
                                </ul>
                            </li>
                            <li><a><i class="fa fa-files-o"></i>  Proyek  <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="../dosen/dosen_setproyek.html">Tambah Proyek</a></li>
                                    <li><a href="../dosen/dosen_listproyek.html">Daftar Proyek</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
