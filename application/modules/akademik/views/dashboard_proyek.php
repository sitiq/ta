        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    Selected >
                    <a href="<?php echo base_url(); ?>akademik/proyek/accept_multiple" title="Setujui yang dicentang" name="accept_multiple" id="accept_multiple" class="btn btn-success">
                        <i class="glyphicon glyphicon-ok"></i>  Accept Checked
                    </a>
