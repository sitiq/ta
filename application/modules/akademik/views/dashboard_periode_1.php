<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <a href="adduser.html">
                    <a href="<?php echo base_url() ?>akademik/periode/add_form" class="btn btn-success pull-right" style="margin-bottom: 2%"> <i class="fa fa-plus"></i> Add New Periode</button>
                    </a>
                    <table id="datatable" class="table table-striped table-bordered dt-responsive bulk_action" cellspacing="0"
                        width="100%">
                        <thead>
                            <tr>
                                <th>Nama Periode</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo ($data->status == 0 ? '<span class="label label-success">Aktif</span>' : '<span class="label label-default">Tidak Aktif</span>'); ?>
                                </td>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-sm btn-danger" data-id="<?php echo $data->id_periode; ?>" data-toggle='modal' id="delete_modal" data-target='#deleteModal'>
